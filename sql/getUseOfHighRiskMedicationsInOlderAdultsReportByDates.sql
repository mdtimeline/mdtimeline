...
#     SET @end_date = '2024-01-01';
    ...
    THEN
        ...
        SELECT e.pid,
               IF(e.total > 1, '1', '0') as medication_was_prescribed
        FROM (SELECT enc.pid, pm.RXCUI, COUNT(pm.RXCUI) AS total
              FROM encounters as enc
                       INNER JOIN patient p ON enc.pid = p.pid
                       LEFT JOIN patient_medications AS pm ON enc.pid = pm.pid AND enc.eid = pm.eid
                       INNER JOIN patient_insurances AS pi ON p.pid = pi.pid AND pm.RXCUI IN
    ...
    ELSE
        ...
        FROM (SELECT enc.pid, pm.RXCUI, COUNT(pm.RXCUI) AS total
              FROM encounters as enc
                       INNER JOIN patient p ON enc.pid = p.pid
                       LEFT JOIN patient_medications AS pm ON enc.pid = pm.pid AND enc.eid = pm.eid AND pm.RXCUI IN
                                  ('1000351', '1000352', '1000355', '1000356', '1000395', '1000398', '1000486',
                                   '1000490', '1000496', '1010696', '1012904', '1013619', '1014331', '1020477',
                                   '1037234', '1041814', '1042684', '1042688', '1042693', '1043400', '1046384',
                                   '1046751', '1046770', '1046781', '1046787', '1046799', '`1046815`', '1046982',
