    ...
    THEN
        ...
        SELECT e.eid,
               ...
               IF(EXISTS(
                          ...
                          WHERE m.pid = e.pid
                            AND RXCUI IN ('1000001', '1091646', '1091652', '1235144', '1235151', '1299859', '1299871',
                                          '1299890', '1299896', '1299897', '1435624', '153822', '153823', '1600716',
                                          '1600724', '1600728', '1656340', '1656349', '1656354', '197436', '197437',
                                          '197438', '197439', '197884', '197885', '197886', '197887', '198188',
                                          '198189', '199351', '199352', '199353', '200094', '200095', '200096',
                                          '200284', '200285', '205304', '205305', '205326', '261962', '282755',
                                          '283316', '283317', '308962', '308963', '308964', '310140', '310792',
                                          '310793', '310796', '310797', '310809', '311353', '311354', '312748',
                                          '312749', '312750', '314076', '314077', '314203', '317173', '349199',
                                          '349200', '349201', '349353', '349373', '349401', '349405', '349483',
                                          '351292', '351293', '403853', '403854', '403855', '477130', '485471',
                                          '577776', '578325', '578330', '636042', '636045', '639537', '722126',
                                          '722131', '722134', '722137', '730861', '730866', '730869', '730872',
                                          '802749', '845488', '848131', '848135', '848140', '848145', '848151',
                                          '854925', '854984', '854988', '857166', '857169', '857174', '857183',
                                          '857187', '858804', '858810', '858813', '858817', '858824', '858828',
                                          '876514', '876519', '876524', '876529', '897781', '897783', '897844',
                                          '897853', '898342', '898346', '898350', '898353', '898356', '898359',
                                          '898362', '898367', '898372', '898378', '898687', '898690', '898719',
                                          '898723', '979464', '979468', '979471', '979480', '979485', '979492',
                                          '999967', '999986', '999991', '999996')
                            AND ((m.date_ordered BETWEEN start_date AND end_date) OR
                                 (m.is_active AND m.begin_date BETWEEN DATE_SUB(start_date, INTERVAL 1 YEAR) AND end_date))),
                  '1', '0') as was_prescribed_or_active
        FROM (SELECT enc.pid, enc.eid
