        ...
        THEN
            ...
            SELECT
                ...
                IF( EXISTS(
                            ...
                            AND pi.code IN ('304549008', '307818003', '370847001', '386291006', '386292004', '386373004', '386463000', '386464006',
                            '410177006', '413315001', '418995006', '424753004', '429095004', '443288003')
                        ), '1', '0') as has_BMI_and_intervention

            FROM
                (SELECT enc.pid, MAX(enc.service_date) AS service_date
