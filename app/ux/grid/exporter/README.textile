...
* Include "App.ux.grid.exporter.Exporter" in requires of your App
...
p. The provided 'exportbutton' is just a specialised Ext.Button subclass which uses App.ux.grid.exporter.FileSaver to save file locally or download remotely.
