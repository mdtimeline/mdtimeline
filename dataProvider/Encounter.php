...
//		if($encounter['review_medications'] && isset($encounter)){
		if(isset($encounter)){
			...
			$active_medications = $ActiveMedications->getPatientActiveMedicationsByPidAndDates($encounter['pid'], true, null, date('Y-m-d 23:59:59', strtotime($encounter['service_date'])));
