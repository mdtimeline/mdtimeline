...
DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `getCoronaryArteryDiseaseBetaBlockerReportByDates`(IN provider_id INT, IN insurance_id INT, IN start_date DATE, IN end_date DATE, IN sex CHAR)
BEGIN
...
#     SET @end_date = '2024-01-01';
    ...
    IF insurance_id > 0
        THEN
                ...
                IF( EXISTS (
                            ...
                            WHERE dxe.pid = e.pid
                              ...
                              AND dx.code IN ('I20.9', 'I21', 'I21.0', 'I21.01', 'I21.02', 'I21.09', 'I21.1', 'I21.11',
                                              ...
                                              'I21.A1', 'I21.A9', 'I22', 'I22.0', 'I22.1', 'I22.2', 'I22.8', 'I22.9', 'I23',
                                              'I23.0', 'I23.1', 'I23.2', 'I23.3', 'I23.4', 'I23.5', 'I23.6', 'I23.7',
            ...
            FROM
                (SELECT enc.pid, enc.eid, enc.service_date
